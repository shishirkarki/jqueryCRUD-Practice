...
<script>
    $(document).ready(function () {
        ...
        $(document).on('click', '.add_student', function (e) {
            ...
            // post request
            $.ajax({
                type: "POST",  //type is post because we have post data in database
                url: "/students", //this is from web.php for routing
                data: data, //this is fromabove var data which already have taken data from form
                dataType: "json", //this type is json because we have send data in json format from sontroller
                success: function (response) {
                    // console.log(response);
                    //is something wrong this error will hit
